            ...
            <div className="grid grid-cols-1 gap-5 items-center">
                <div
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <p className={"text-zinc-900 dark:text-white"}> Frontend</p>
                    </div>
                ...
                <div
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <p className={"text-zinc-900 dark:text-white"}>Backend</p>
                    </div>
                ...
                <div
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <p className={"text-zinc-900 dark:text-white"}>Modeling</p>
                    </div>
