    ...
    return (
        <div className={'p-8 md:p-0 mb-16 w-full md:w-3/4 lg:w-2/5'}>
            ...
            <div className="grid grid-cols-1 gap-7 items-center">
                ...
                <div
                    className="z-0 relative flex flex-col gap-3 rounded-md border border-neutral-300 hover:border-neutral-600 dark:border-neutral-500 dark:hover:border-neutral-600 py-4 px-6 transition-colors duration-300">
