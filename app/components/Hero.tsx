    ...
    return (
        <div className="px-8 mb-16 pt-6 md:pl-0 flex flex-col items-center justify-center w-full md:w-2/3 lg:w-1/3">
            ...
            <div className="flex flex-col">
                <RevealList interval={100} delay={100} origin={'left'}>
                    ...
                    <strong className={"text-2xl font-bold text-zinc-950 mt-10 dark:text-white"}>
                        Hey, I&apos;m Wilfried Musanzi Fullsatck JavaScript developer.
                    </strong>
                    <p className={'mt-8'}>
